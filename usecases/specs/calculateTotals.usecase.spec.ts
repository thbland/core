...
import { CalculateTotalsUseCase } from '../src/calculateTotals.usecase';
import { iIsncsciExamModel } from '../src/iIsncsciExamModel';
import { isncsciValidationTests } from '../../domain/specs/isncsci-validation-tests';
