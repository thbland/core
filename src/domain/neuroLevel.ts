...
/**
 * The 'rhi-core-isncsci-level' contains all the values for a specific
 * neurological level required in the calculation of an ISNCSCI exam.
...
export class NeuroLevel {
    ...
    public isncsciExam: IsncsciExam | null = null;
    ...
    public name: string = '';
    public next: NeuroLevel | null = null;
    public ordinal: number = 0;
    public previous: NeuroLevel | null = null;
     ...
     */
    public setValues(
            ordinal: number, isKeyMuscle: boolean, isLowerMuscle: boolean,
        ...
        this.rightTouchValue = rightTouchValue;
