...
/**
 * The 'rhi-core-isncsci-totals' contains the raw results from
 * running an ISNCSCI Examination through the ISNCSCI Algorithm.
...
export class IsncsciTotals {
    ...
    private static getValuesString(values: NeuroLevel[]): string {
        ...
        let result: string = '';
        const sortedList: NeuroLevel[] = values.sort((a: NeuroLevel, b: NeuroLevel) => a.ordinal - b.ordinal);
     ...
     * @param {boolean} hasImpairmentNotDueToSci Flag indicating if any value used in the calculation of this total
     *                                           presents impairment not due to a spinal cord injury.
     * @param {boolean} containsNt Flag indicating if any value used in the calculation
     *                             of this total is set to Not Testable.
     *
     * @returns {string} The value, followed by an exclamation mark if the hasImpairmentNotDueToSci is
     *                   set to true or UTD (Unable to determine) if the containsNt flag is set to true.
     */
    ...
    public mostCaudalLeftLevelWithMotorFunction: NeuroLevel | null = null;
    public mostCaudalLeftMotor: NeuroLevel | null = null;
    public mostCaudalNeurologicalLevelOfInjury: NeuroLevel | null = null;
    public mostCaudalRightLevelWithMotorFunction: NeuroLevel | null = null;
    public mostCaudalRightMotor: NeuroLevel | null = null;
    public mostRostralLeftLevelWithMotorFunction: NeuroLevel | null = null;
    public mostRostralLeftMotor: NeuroLevel | null = null;
    public mostRostralNeurologicalLevelOfInjury: NeuroLevel | null = null;
    public mostRostralRightLevelWithMotorFunction: NeuroLevel | null = null;
    public mostRostralRightMotor: NeuroLevel | null = null;
     ...
     *
     * @param {NeuroLevel} level (required) The neurological level to be added
     *                           to the neurological level of injury values.
     */
    public addNeurologicalLevelOfInjury(level: NeuroLevel): void {
        ...
        if (this.mostRostralNeurologicalLevelOfInjury == null
                || level.ordinal < this.mostRostralNeurologicalLevelOfInjury.ordinal) {
            this.mostRostralNeurologicalLevelOfInjury = level;
        }

        if (this.mostCaudalNeurologicalLevelOfInjury == null
                || level.ordinal > this.mostCaudalNeurologicalLevelOfInjury.ordinal) {
     ...
     *
     * @param {NeuroLevel} level (required) The neurological level to be added to the possible right sensory ZPP values.
     */
     ...
     *
     * @param {NeuroLevel} level (required) The neurological level to be added to the possible left sensory ZPP values.
     */
     ...
     *
     * @param {NeuroLevel} level (required) The neurological level to be added to the possible right motor ZPP values.
     */
     ...
     *
     * @param {NeuroLevel} level (required) The neurological level to be added to the possible left motor ZPP values.
     */
    ...
    public getLeftLowerMotorTotal(): string {
        return IsncsciTotals.getSummaryStringFor(this.leftLowerMotorTotal,
            this.leftLowerMotorTotalHasImpairmentNotDueToSci, this.leftLowerMotorContainsNt);
    }
    ...
    public getLeftMotorTotal(): string {
        return IsncsciTotals.getSummaryStringFor(this.leftUpperMotorTotal + this.leftLowerMotorTotal,
                    this.leftUpperMotorTotalHasImpairmentNotDueToSci
                        || this.leftLowerMotorTotalHasImpairmentNotDueToSci,
    ...
    public getLeftPrickTotal(): string {
        return IsncsciTotals.getSummaryStringFor(this.leftPrickTotal,
            this.leftPrickTotalHasImpairmentNotDueToSci, this.leftPrickContainsNt);
    }
    ...
    public getLeftTouchTotal(): string {
        return IsncsciTotals.getSummaryStringFor(this.leftTouchTotal,
            this.leftTouchTotalHasImpairmentNotDueToSci, this.leftTouchContainsNt);
    }
    ...
    public getLeftUpperMotorTotal(): string {
        return IsncsciTotals.getSummaryStringFor(this.leftUpperMotorTotal,
            this.leftUpperMotorTotalHasImpairmentNotDueToSci, this.leftUpperMotorContainsNt);
    }
    ...
    public getLowerMotorTotal(): string {
        return IsncsciTotals.getSummaryStringFor(this.rightLowerMotorTotal + this.leftLowerMotorTotal,
                    this.rightLowerMotorTotalHasImpairmentNotDueToSci
                        || this.leftLowerMotorTotalHasImpairmentNotDueToSci,
    ...
    public getRightLowerMotorTotal(): string {
        return IsncsciTotals.getSummaryStringFor(this.rightLowerMotorTotal,
            this.rightLowerMotorTotalHasImpairmentNotDueToSci, this.rightLowerMotorContainsNt);
    }
    ...
    public getRightMotorTotal(): string {
        return IsncsciTotals.getSummaryStringFor(this.rightUpperMotorTotal + this.rightLowerMotorTotal,
                    this.rightUpperMotorTotalHasImpairmentNotDueToSci
                        || this.rightLowerMotorTotalHasImpairmentNotDueToSci,
    ...
    public getRightPrickTotal(): string {
        return IsncsciTotals.getSummaryStringFor(this.rightPrickTotal,
            this.rightPrickTotalHasImpairmentNotDueToSci, this.rightPrickContainsNt);
    }
    ...
    public getRightTouchTotal(): string {
        return IsncsciTotals.getSummaryStringFor(this.rightTouchTotal,
            this.rightTouchTotalHasImpairmentNotDueToSci, this.rightTouchContainsNt);
    }
    ...
    public getRightUpperMotorTotal(): string {
        return IsncsciTotals.getSummaryStringFor(this.rightUpperMotorTotal,
            this.rightUpperMotorTotalHasImpairmentNotDueToSci, this.rightUpperMotorContainsNt);
    }
